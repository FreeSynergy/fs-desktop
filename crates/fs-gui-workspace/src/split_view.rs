...
pub fn SplitView(props: SplitViewProps) -> Element {
    ...
    rsx! {
        div {
            ...
            // Master pane
            div { class: "fs-split__master", style: "{master_style}", {props.master} }

            // Resize handle (only visible in Half mode)
            if is_half {
                div {
                    class: "fs-split__handle",
            ...
            // Detail pane
            div { class: "fs-split__detail", style: "flex: 1; overflow: hidden;", {props.children} }
        }
    }
}
