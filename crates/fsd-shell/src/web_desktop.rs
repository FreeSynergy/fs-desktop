...
pub fn WebDesktop(props: WebDesktopProps) -> Element {
    ...
    rsx! {
        div {
            class: "fsd-web-desktop",
            style: "display: flex; flex-direction: column; height: 100dvh; \
                    background: var(--fsn-bg-base, #0a0f1a); overflow: hidden; \
                    position: relative;",
            ...
            // ── Bottom taskbar ─────────────────────────────────────────────
            div {
                class: "fsd-web-desktop__taskbar",
                ...
                div {
                    style: "display: flex; justify-content: center; align-items: center; \
                            height: 20px; background: var(--fsn-bg-sidebar); \
                            border-top: 1px solid var(--fsn-border); cursor: pointer; \
                    ...
                    div {
                        style: "width: 36px; height: 4px; border-radius: 2px; \
                                background: var(--fsn-text-muted, #64748b);",
                    }
                }
        ...
        header {
            ...
            button {
                style: "background: none; border: none; cursor: pointer; padding: 6px 8px; \
                        border-radius: var(--fsn-radius-sm); font-size: 18px; line-height: 1; \
            ...
            div {
                ...
                span {
                    style: "font-size: 15px; font-weight: 700; color: var(--fsn-primary); \
                ...
                if notification_count > 0 {
                    div {
                        style: "position: absolute; top: 2px; right: 2px; \
                                background: var(--fsn-danger, #ef4444); color: #fff; \
            ...
            div {
                style: "display: flex; align-items: center; gap: 6px; \
                        padding: 4px 8px; border-radius: var(--fsn-radius-sm); \
                        background: var(--fsn-bg-elevated);",
                div {
                    style: "width: 24px; height: 24px; border-radius: 50%; flex-shrink: 0; \
                            background: var(--fsn-primary); display: flex; \
                            align-items: center; justify-content: center; \
                            font-size: 11px; font-weight: 600; color: #fff;",
                    "{initial}"
                }
                span {
                    style: "font-size: 12px; color: var(--fsn-text-primary); \
...
fn WebTaskbarBody(
    ...
    rsx! {
        div {
            class: "fsd-web-taskbar__body",
            style: "height: 48px; background: var(--fsn-bg-sidebar, #0a0f1a); \
            ...
            for app in &apps {
                button {
                    ...
                    style: "display: flex; flex-direction: column; align-items: center; justify-content: center; \
                            ...
                            padding: 4px 8px; border-radius: var(--fsn-radius-sm); flex-shrink: 0; \
