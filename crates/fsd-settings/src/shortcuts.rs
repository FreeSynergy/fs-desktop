                                ...
                                for action in cat_actions {
                                    {
                                        ...
                                        rsx! {
                                            div {
                                                ...
                                                span {
                                                    style: "font-size: 13px; color: var(--fsn-text-primary); flex: 1;",
                                                    "{action.label}"
                                                }
                                                div { style: "display: flex; align-items: center; gap: 6px;",
                                                    ...
                                                    button {
                                                        style: if is_recording {
                                                            "min-width: 120px; padding: 3px 10px; font-size: 12px; \
                                                             ...
                                                             background: var(--fsn-primary); color: var(--fsn-primary-text); \
                                                             border: 1px solid var(--fsn-primary); font-family: var(--fsn-font-mono);"
                                                        } else {
                                                            "min-width: 120px; padding: 3px 10px; font-size: 12px; \
                                                             border-radius: var(--fsn-radius-sm); cursor: pointer; \
                                                             background: var(--fsn-bg-elevated); color: var(--fsn-text-secondary); \
                                                             border: 1px solid var(--fsn-border); font-family: var(--fsn-font-mono);"
                                                        },
                                                        onclick: move |_| {
                                                    ...
                                                    if !is_default {
                                                        button {
                                                            style: "padding: 3px 8px; font-size: 11px; border-radius: var(--fsn-radius-sm); \
                                                                    cursor: pointer; background: none; color: var(--fsn-text-muted); \
