            ...
            div { style: "margin-bottom: 24px;",
                div { style: "display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;",
                    ...
                    if cap_type.read().is_some() {
                        button {
                            style: "padding: 4px 10px; background: none; border: 1px solid var(--fsn-color-border-default); \
                        ...
                        if ct == "messenger" {
                            div {
                                ...
                                if link_token.read().is_none() {
                                    button {
                                        style: "padding: 6px 14px; background: var(--fsn-color-primary); color: white; \
                                ...
                                if let Some(token) = link_token.read().clone() {
                                    div {
                                        ...
                                        if token.is_expired() {
                                            p { style: "color: var(--fsn-color-error); margin: 0 0 8px;",
                                                "⚠ Token expired. Please regenerate."
                                            }
                                        } else {
                                            p { style: "margin: 0 0 6px; color: var(--fsn-color-text-muted);",
                                            ...
                                            div {
                                                style: "font-family: var(--fsn-font-mono); font-size: 16px; font-weight: 700; \
                                            ...
                                            p { style: "margin: 0 0 12px; font-size: 12px; color: var(--fsn-color-text-muted);",
                                        ...
                                        div { style: "display: flex; gap: 8px; flex-wrap: wrap;",
                                            ...
                                            button {
                                                style: "padding: 5px 12px; background: var(--fsn-color-primary); color: white; \
                                                        border: none; border-radius: var(--fsn-radius-md); cursor: pointer; font-size: 13px;",
                                                onclick: move |_| {
                ...
                for (idx, cap) in profile.read().personal_capabilities.iter().enumerate() {
                    div {
                        ...
                        div { style: "flex: 1;",
                            div { style: "font-size: 12px; color: var(--fsn-color-text-muted);", "{cap.kind_label()}" }
