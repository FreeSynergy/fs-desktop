        ...
        div { style: "display: flex; gap: 20px; height: 100%; overflow: hidden;",
            ...
            div {
                style: "width: 240px; flex-shrink: 0; display: flex; flex-direction: column; gap: 10px; \
                        border-right: 1px solid var(--fsn-border); padding-right: 16px; overflow-y: auto;",

                div {
                    style: "display: flex; align-items: center; justify-content: space-between;",
                    span {
                        style: "font-size: 12px; font-weight: 600; text-transform: uppercase; \
                                letter-spacing: 0.06em; color: var(--fsn-color-text-muted);",
                        "Collections"
                    }
                    button {
                        style: "background: var(--fsn-color-primary); color: #fff; border: none; \
                                border-radius: var(--fsn-radius-sm); padding: 3px 8px; font-size: 11px; cursor: pointer;",
                ...
                if *show_new_col.read() {
                    div {
                        style: "display: flex; flex-direction: column; gap: 6px; padding: 8px; \
                                background: var(--fsn-color-bg-overlay); border-radius: var(--fsn-radius-md);",
                        input {
                            style: "background: var(--fsn-color-bg-base); border: 1px solid var(--fsn-color-border-default); \
                                    border-radius: var(--fsn-radius-sm); padding: 5px 8px; font-size: 12px; \
                        ...
                        button {
                            style: "background: var(--fsn-color-primary); color: #fff; border: none; \
                                    border-radius: var(--fsn-radius-sm); padding: 5px 10px; font-size: 12px; cursor: pointer;",
                            onclick: move |_| {
                ...
                // All Rooms entry
                {
                    ...
                    rsx! {
                        div {
                            style: if active {
                                "padding: 7px 10px; border-radius: var(--fsn-radius-md); cursor: pointer; \
                                 background: var(--fsn-color-primary); color: #fff; font-size: 13px;"
                            } else {
                                "padding: 7px 10px; border-radius: var(--fsn-radius-md); cursor: pointer; \
                                 color: var(--fsn-color-text-primary); font-size: 13px;"
                            },
            ...
            div { style: "flex: 1; display: flex; flex-direction: column; gap: 12px; overflow: hidden;",
                ...
                div { style: "display: flex; gap: 8px; flex-wrap: wrap;",
                    select {
                        style: "padding: 5px 8px; font-size: 12px; border-radius: var(--fsn-radius-sm); \
                                border: 1px solid var(--fsn-color-border-default); \
                                background: var(--fsn-color-bg-overlay); color: var(--fsn-color-text-primary);",
                    ...
                    input {
                        style: "padding: 5px 8px; font-size: 12px; border-radius: var(--fsn-radius-sm); \
                                border: 1px solid var(--fsn-color-border-default); flex: 1; \
                                background: var(--fsn-color-bg-overlay); color: var(--fsn-color-text-primary);",
                    ...
                    input {
                        style: "padding: 5px 8px; font-size: 12px; border-radius: var(--fsn-radius-sm); \
                                border: 1px solid var(--fsn-color-border-default); width: 80px; \
                                background: var(--fsn-color-bg-overlay); color: var(--fsn-color-text-primary);",
                ...
                if !selected_rooms.read().is_empty() {
                    div {
                        style: "display: flex; align-items: center; gap: 10px; padding: 8px 12px; \
                                background: var(--fsn-color-bg-overlay); border-radius: var(--fsn-radius-md); font-size: 13px;",
                        span { style: "color: var(--fsn-color-text-muted);",
                            "{selected_rooms.read().len()} selected"
                        }
                        if let Some(col_id) = *sel_collection.read() {
                            button {
                                style: "background: #ef4444; color: #fff; border: none; border-radius: var(--fsn-radius-sm); \
                        ...
                        for col in collections.read().clone().iter() {
                            {
                                ...
                                rsx! {
                                    button {
                                        key: "{col.id}",
                                        style: "background: var(--fsn-color-primary); color: #fff; border: none; \
                                                border-radius: var(--fsn-radius-sm); padding: 4px 12px; font-size: 12px; cursor: pointer;",
                                        onclick: move |_| {
                                            let sel = selected_rooms.read().clone();
                        ...
                        button {
                            style: "background: transparent; color: var(--fsn-color-text-muted); border: none; \
                                    ...
                                    rsx! {
                                        div {
                                            ...
                                            style: "display: flex; align-items: center; gap: 10px; \
                                                    padding: 8px 12px; border-radius: var(--fsn-radius-md); \
                                                    background: var(--fsn-color-bg-overlay); font-size: 13px; \
                                                    cursor: pointer;",
                                            onclick: move |_| {
                                                if checked {
                                            ...
                                            span {
                                                style: "color: var(--fsn-color-primary); font-size: 15px;",
                                                if checked { "☑" } else { "☐" }
                                            }
                                            span {
                                                style: "color: var(--fsn-color-text-muted); font-size: 11px; \
                                                        background: var(--fsn-color-bg-base); padding: 1px 5px; \
                                                        border-radius: 3px;",
                                                "{room.platform}"
                                            }
                                            span {
                                                style: "flex: 1; color: var(--fsn-color-text-primary); font-weight: 500;",
                                                "{room.room_name}"
                                            }
