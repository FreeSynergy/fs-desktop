...
pub fn AccountsView() -> Element {
    ...
    rsx! {
        div { style: "display: flex; flex-direction: column; gap: 20px; max-width: 700px;",
            ...
            div {
                style: "padding: 16px; border-radius: var(--fsn-radius-md, 8px); \
                ...
                p {
                    style: "margin: 0 0 4px; font-size: 13px; color: var(--fsn-color-text-muted);",
                ...
                if accounts.read().is_empty() {
                    div {
                        style: "padding: 24px; text-align: center; \
                                ...
                                background: var(--fsn-color-bg-surface, #1e293b); \
                                border-radius: var(--fsn-radius-md, 8px); \
                                border: 1px solid var(--fsn-color-border-default, #334155);",
            ...
            if *show_form.read() {
                div {
                    style: "padding: 20px; border-radius: var(--fsn-radius-md, 8px); \
                            background: var(--fsn-color-bg-surface, #1e293b); \
                            border: 1px solid var(--fsn-color-primary, #00bcd4);",
                    ...
                    div { style: "display: flex; flex-direction: column; gap: 14px;",
                        ...
                        div {
                            ...
                            select {
                                style: "width: 100%; background: var(--fsn-color-bg-base, #0f172a); \
                                        border: 1px solid var(--fsn-color-border-default, #334155); \
                        ...
                        div {
                            ...
                            input {
                                ...
                                style: "width: 100%; background: var(--fsn-color-bg-base, #0f172a); \
                                        ...
                                        border-radius: var(--fsn-radius-md, 6px); \
                                        padding: 8px 10px; font-size: 13px; \
                                        color: var(--fsn-color-text-primary); box-sizing: border-box;",
                        ...
                        div { style: "display: flex; gap: 10px;",
                            button {
                                style: "background: var(--fsn-color-primary, #00bcd4); color: #fff; \
                                        border: none; border-radius: var(--fsn-radius-md, 6px); \
                            ...
                            button {
                                style: "background: transparent; \
                                        ...
                                        color: var(--fsn-color-text-muted); cursor: pointer;",
    ...
    rsx! {
        div {
            style: "display: flex; align-items: center; gap: 12px; \
                    padding: 12px 14px; border-radius: var(--fsn-radius-md, 8px); \
                    background: var(--fsn-color-bg-surface, #1e293b); \
                    border: 1px solid var(--fsn-color-border-default, #334155);",
            ...
            div { style: "flex: 1;",
                div {
                    style: "font-size: 13px; font-weight: 600; color: var(--fsn-color-text-primary);",
                    "{account.label}"
                }
                div {
            ...
            button {
                style: "padding: 4px 12px; background: transparent; \
                        border: 1px solid var(--fsn-color-border-default, #334155); \
                        border-radius: var(--fsn-radius-md, 6px); \
                        font-size: 12px; color: var(--fsn-color-text-muted); cursor: pointer;",
                "Edit"
            }
